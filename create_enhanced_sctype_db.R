...
# Create comprehensive marker database
create_enhanced_database <- function() {

  # Initialize data frame with required columns
  db <- data.frame(
    tissueType = character(),
    cellName = character(),
    shortName = character(),
    geneSymbolmore1 = character(),  # Positive markers
    geneSymbolmore2 = character(),  # Negative markers
  ...
  immune_cells <- rbind(
    ...
    data.frame(
      tissueType = "Immune system",
      cellName = "Follicular helper T cells",
      shortName = "Tfh",
    ...
    data.frame(
      tissueType = "Immune system",
      cellName = "Plasmablasts",
      shortName = "Plasmablast",
    ...
    data.frame(
      tissueType = "Immune system",
      cellName = "Non-classical monocytes",
      shortName = "ncMono",
    ...
    data.frame(
      tissueType = "Immune system",
      cellName = "Intermediate monocytes",
      shortName = "intMono",
    ...
    data.frame(
      tissueType = "Immune system",
      cellName = "Hematopoietic stem cells",
      shortName = "HSC",
  ...
  brain_cells <- rbind(
    ...
    data.frame(
      tissueType = "Brain",
      cellName = "GABAergic neurons",
      shortName = "GABANeuron",
      geneSymbolmore1 = "GAD1,GAD2,SLC32A1,DLX1,SST,PVALB,VIP",
      geneSymbolmore2 = "SLC17A7,SLC17A6,GFAP,MBP"
    ),
    data.frame(
      tissueType = "Brain",
      cellName = "Serotonergic neurons",
      shortName = "5HTNeuron",
    ...
    data.frame(
      tissueType = "Brain",
      cellName = "Oligodendrocyte precursor cells",
      shortName = "OPC",
    ...
    data.frame(
      tissueType = "Brain",
      cellName = "Vascular smooth muscle cells",
      shortName = "VSMC",
  ...
  liver_cells <- rbind(
    ...
    data.frame(
      tissueType = "Liver",
      cellName = "Periportal hepatocytes",
      shortName = "PP_Hepato",
    ...
    data.frame(
      tissueType = "Liver",
      cellName = "Pericentral hepatocytes",
      shortName = "PC_Hepato",
    ...
    data.frame(
      tissueType = "Liver",
      cellName = "Hepatic stellate cells",
      shortName = "HSC",
    ...
    data.frame(
      tissueType = "Liver",
      cellName = "Liver sinusoidal endothelial cells",
      shortName = "LSEC",
    ...
    data.frame(
      tissueType = "Liver",
      cellName = "Hepatic progenitor cells",
      shortName = "HepProg",
  ...
  pancreas_cells <- rbind(
    ...
    data.frame(
      tissueType = "Pancreas",
      cellName = "Pancreatic stellate cells",
      shortName = "PSC",
  ...
  kidney_cells <- rbind(
    ...
    data.frame(
      tissueType = "Kidney",
      cellName = "Proximal tubule cells",
      shortName = "PT",
    ...
    data.frame(
      tissueType = "Kidney",
      cellName = "Distal convoluted tubule",
      shortName = "DCT",
    ...
    data.frame(
      tissueType = "Kidney",
      cellName = "Collecting duct principal cells",
      shortName = "PC",
    ...
    data.frame(
      tissueType = "Kidney",
      cellName = "Collecting duct intercalated cells",
      shortName = "IC",
    ...
    data.frame(
      tissueType = "Kidney",
      cellName = "Glomerular endothelial cells",
      shortName = "GEC",
    ...
    data.frame(
      tissueType = "Kidney",
      cellName = "Parietal epithelial cells",
      shortName = "PEC",
  ...
  heart_cells <- rbind(
    ...
    data.frame(
      tissueType = "Heart",
      cellName = "Atrial cardiomyocytes",
      shortName = "ACM",
    ...
    data.frame(
      tissueType = "Heart",
      cellName = "Ventricular cardiomyocytes",
      shortName = "VCM",
  ...
  # Intestine
  intestine_cells <- rbind(
    data.frame(
      tissueType = "Intestine",
      cellName = "Enterocytes",
      shortName = "Entero",
    ...
    data.frame(
      tissueType = "Intestine",
      cellName = "Enteroendocrine cells",
      shortName = "EE",
    ...
    data.frame(
      tissueType = "Intestine",
      cellName = "Intestinal stem cells",
      shortName = "ISC",
  ...
  muscle_cells <- rbind(
    data.frame(
      tissueType = "Muscle",
      cellName = "Skeletal muscle cells",
      shortName = "SkMuscle",
  ...
  # Combine all tissue-specific markers
  db <- rbind(
    immune_cells,
    brain_cells,
    liver_cells,
...
# Create the database
cat("Creating enhanced ScType database...\n")
enhanced_db <- create_enhanced_database()

cat(sprintf("Database created with %d entries across %d tissue types\n",
            nrow(enhanced_db),
            length(unique(enhanced_db$tissueType))))

# Save to Excel file
output_file <- "/home/user/sc-type/ScTypeDB_enhanced.xlsx"
write.xlsx(enhanced_db, output_file, overwrite = TRUE)

cat(sprintf("Database saved to: %s\n", output_file))

# Print summary statistics
cat("\n=== Database Summary ===\n")
for(tissue in sort(unique(enhanced_db$tissueType))) {
  n_cells <- sum(enhanced_db$tissueType == tissue)
  cat(sprintf("%-20s: %3d cell types\n", tissue, n_cells))
}
